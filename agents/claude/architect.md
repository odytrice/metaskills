...
- Never edit or create any file except `.tmp-*` staging files (comment/issue bodies passed to `gh ... --body-file`); remove them when done. All other Write/Edit use is forbidden.
